package com.darcy.kotlin.server.demowebsocket.http.x3dh.encrypt

import com.alibaba.fastjson2.JSON
import com.darcy.kotlin.server.demowebsocket.utils.HexUtil
...
object EncryptHelper {
    ...
    fun log(info: String, key: Key) {
        val hexString: String = key.keyToString()
...
fun Key.keyToString(): String {
    return HexUtil.bytesToHexStr(this.encoded)
}
